...
mod_benchmark_rule_details = api.model('BenchmarkRuleDetails', {
    ...
    'remediation_advice': fields.String(description='Advice on how to remediate the rule'),
    ...
    'remediate': fields.Nested(mod_benchmark_rule_assess, description='The script to remediate the rule'),
    'risk_score': fields.Integer(description='A risk score to set on alerts generated by this rule'),
    'secure_score': fields.Integer(description='A secure score to set on alerts generated by this rule'),
