...
class Case(Base):
    ...
    observables = db.relationship(
        'Observable', secondary=observable_case_association, cascade='delete')
    ...
    tasks = db.relationship("CaseTask", back_populates='case', cascade='delete')
    history = db.relationship("CaseHistory", back_populates='case', cascade='delete')
