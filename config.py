...
class Config(object):
    ...
    NODE_ROLE = os.getenv('REFLEX_NODE_ROLE') if os.getenv('REFLEX_NODE_ROLE') else 'primary'
    ...
    ELASTICSEARCH_URL = os.getenv('REFLEX_ES_URL').split(',') if os.getenv('REFLEX_ES_URL') else ['localhost:9200']
    ...
    ELASTICSEARCH_MAX_RETRIES = int(os.getenv('REFLEX_ES_MAX_RETRIES')) if os.getenv('REFLEX_ES_MAX_RETRIES') else 3
    ...
    DETECTION_DAILY_ASSESS = as_bool(os.getenv('REFLEX_DETECTION_DAILY_ASSESS')) if os.getenv('REFLEX_DETECTION_DAILY_ASSESS') else False
