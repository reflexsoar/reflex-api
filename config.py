...
class Config(object):
    ...
    DETECTION_STATE_REBALANCE_INTERVAL = int(os.getenv('REFLEX_DETECTION_STATE_REBALANCE_INTERVAL')) if os.getenv('REFLEX_DETECTION_STATE_REBALANCE_INTERVAL') else 10 # Default to 60 seconds
